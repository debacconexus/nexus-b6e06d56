...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Humanoid Robot Workplace Safety Nexus";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "incident";
process.env.TABLE_NAME = process.env.TABLE_NAME || "incident_records";
'use strict';
